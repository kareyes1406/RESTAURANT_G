...
public class CD_EnvioCorreos
{
    ...
    public bool EnviarCorreoAdmin(string destinatario, string asunto, int codigoVerificacion)
    {
        try
        {
            // Plantilla HTML del correo
    ...
    public bool EnviarRecuperarAdmin(string destinatario, string asunto, int codigoVerificacion)
    {
        try
        {// Plantilla HTML del correo
            string cuerpo = $@"
